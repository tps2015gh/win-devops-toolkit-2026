...
func (v Vector50) Dot(other Vector50) float32 {
	var sum float32
	for i := 0; i < 50; i++ {
		sum += v[i] * other[i]
	}
...
func Vectorize(text string, itemType string, name string) Vector50 {
	var v Vector50
